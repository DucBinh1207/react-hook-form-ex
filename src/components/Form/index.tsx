...
import { IsEmail, IsName, IsPhone, IsPin } from "../../utils/FormRegex";
    ...
    return (
      <>
        <input
          ...
          {...(keyName !== "lastName" && keyName !== "parentLastName"
    ...
    <div className="mx-auto mb-[100px] flex w-[900px] flex-col items-center">
      ...
      >
        ...
        <div className="gender flex flex-col items-start">
          ...
          <select
            id="gender"
            className={`${errors.firstName ? "border-red-500" : "border-[#bbbbbb]"} mt-[5px] h-[50px] w-[100%] rounded-[8px] border-[2px] border-solid px-[20px] text-[17px] font-semibold text-[#4b4b4b] outline-none`}
        ...
        <button
          type="submit"
          className="hover: absolute bottom-[-50px] left-[50%] mt-[50px] translate-x-[-50%] rounded-[8px] border border-solid border-[#4602ae] bg-transparent px-[35px] py-[15px] text-[14px] font-semibold text-[#4602ae] outline-none transition-all duration-300 ease-in-out hover:bg-[#4602ae] hover:text-white hover:transition-all hover:duration-300 hover:ease-in-out"
        >
          Next
        </button>
      </form>
